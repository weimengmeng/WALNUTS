...
public class HttpManager {
    public static final String BASE_URL = "http://116.62.243.41/hetao_api/public/index.php/api/";
    public static final String BASE_URL2 = "http://116.62.243.41/hetao_api/public/";
    /**
     * 设置超时时间，默认6s
     */
