...
public class CustomEditText extends EditText{
    ...
    private int numSize = 24;//字数统计的大小
    ...
    public CustomEditText(Context context, AttributeSet attrs) {
        ...
        mPaint = new Paint();
        int colorGray = getResources().getColor(R.color.txt_color);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(numStr, editWidth-mBound.width()-50, editHeight-mBound.height()-5, mPaint);
    }
    @Override
